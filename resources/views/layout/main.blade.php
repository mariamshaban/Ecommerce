...
<head>
    ...
    <link rel="stylesheet" href="{{url('resources/dist/css/foundation.css')}}"/>
    <link rel="stylesheet" href="{{url('resources/dist/css/app.css')}}"/>
...
<script src="{{url('resources/dist/js/vendor/jquery.js')}}"></script>
